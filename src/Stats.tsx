            ...
            {data && (
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar yAxisId="right" dataKey="reps" barSize={20} fill="#413ea0" name="Reps" />
                        <Line yAxisId="left" type="monotone" dataKey="weight" stroke="#ff7300" name="Weight" />
                    </ComposedChart>
                </ResponsiveContainer>
            )}
...
<div style={{ width: '100%', maxWidth: '800px', height: '400px', padding: '20px' }}>
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
            <CartesianGrid stroke="#f5f5f5" />
            <XAxis dataKey="index" label={{ value: 'Session', position: 'insideBottomRight', offset: -10 }} />
            <YAxis yAxisId="left" label={{ value: 'Weight', angle: -90, position: 'insideLeft' }} />
            <YAxis yAxisId="right" orientation="right" label={{ value: 'Reps', angle: 90, position: 'insideRight' }} />
            <Tooltip />
            <Legend />
